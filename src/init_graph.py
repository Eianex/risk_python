...
def init_graph(G=nx.Graph()) -> nx.Graph:
    G = nx.Graph()
    G.add_node("Alaska", troops=1, owner=1)
    G.add_node("Northwest Territory", troops=1, owner=1)
    G.add_node("Greenland", troops=1, owner=1)
    G.add_node("Alberta", troops=1, owner=1)
    G.add_node("Ontario", troops=1, owner=1)
    G.add_node("Quebec", troops=1, owner=1)
    G.add_node("Western United States", troops=1, owner=1)
    G.add_node("Eastern United States", troops=1, owner=1)
    G.add_node("Central America", troops=1, owner=1)
    G.add_node("Iceland", troops=1, owner=1)
    G.add_node("Great Britain", troops=1, owner=1)
    G.add_node("Scandinavia", troops=1, owner=1)
    G.add_node("Northern Europe", troops=1, owner=1)
    G.add_node("Southern Europe", troops=1, owner=1)
    G.add_node("Ukraine", troops=1, owner=1)
    G.add_node("Western Europe", troops=1, owner=1)
    G.add_node("Venezuela", troops=1, owner=1)
    G.add_node("Peru", troops=1, owner=1)
    G.add_node("Brazil", troops=1, owner=1)
    G.add_node("Argentina", troops=1, owner=1)
    G.add_node("North Africa", troops=1, owner=1)
    G.add_node("Egypt", troops=1, owner=1)
    G.add_node("East Africa", troops=1, owner=1)
    G.add_node("Congo", troops=1, owner=1)
    G.add_node("South Africa", troops=1, owner=1)
    G.add_node("Madagascar", troops=1, owner=1)
    G.add_node("Ural", troops=1, owner=1)
    G.add_node("Siberia", troops=1, owner=1)
    G.add_node("Yakutsk", troops=1, owner=1)
    G.add_node("Kamchatka", troops=1, owner=1)
    G.add_node("Irkutsk", troops=1, owner=1)
    G.add_node("Mongolia", troops=1, owner=1)
    G.add_node("Japan", troops=1, owner=1)
    G.add_node("Afghanistan", troops=1, owner=1)
    G.add_node("China", troops=1, owner=1)
    G.add_node("Middle East", troops=1, owner=1)
    G.add_node("India", troops=1, owner=1)
    G.add_node("Siam", troops=1, owner=1)
    G.add_node("Indonesia", troops=1, owner=1)
    G.add_node("New Guinea", troops=1, owner=1)
    G.add_node("Western Australia", troops=1, owner=1)
    G.add_node("Eastern Australia", troops=1, owner=1)
