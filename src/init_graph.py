...
def init_graph(G=nx.Graph()) -> nx.Graph:
    G = nx.Graph()
    G.add_node("Alaska", troops=0, owner=0)
    G.add_node("Northwest Territory", troops=0, owner=0)
    G.add_node("Greenland", troops=0, owner=0)
    G.add_node("Alberta", troops=0, owner=0)
    G.add_node("Ontario", troops=0, owner=0)
    G.add_node("Quebec", troops=0, owner=0)
    G.add_node("Western United States", troops=0, owner=0)
    G.add_node("Eastern United States", troops=0, owner=0)
    G.add_node("Central America", troops=0, owner=0)
    G.add_node("Iceland", troops=0, owner=0)
    G.add_node("Great Britain", troops=0, owner=0)
    G.add_node("Scandinavia", troops=0, owner=0)
    G.add_node("Northern Europe", troops=0, owner=0)
    G.add_node("Southern Europe", troops=0, owner=0)
    G.add_node("Ukraine", troops=0, owner=0)
    G.add_node("Western Europe", troops=0, owner=0)
    G.add_node("Venezuela", troops=0, owner=0)
    G.add_node("Peru", troops=0, owner=0)
    G.add_node("Brazil", troops=0, owner=0)
    G.add_node("Argentina", troops=0, owner=0)
    G.add_node("North Africa", troops=0, owner=0)
    G.add_node("Egypt", troops=0, owner=0)
    G.add_node("East Africa", troops=0, owner=0)
    G.add_node("Congo", troops=0, owner=0)
    G.add_node("South Africa", troops=0, owner=0)
    G.add_node("Madagascar", troops=0, owner=0)
    G.add_node("Ural", troops=0, owner=0)
    G.add_node("Siberia", troops=0, owner=0)
    G.add_node("Yakutsk", troops=0, owner=0)
    G.add_node("Kamchatka", troops=0, owner=0)
    G.add_node("Irkutsk", troops=0, owner=0)
    G.add_node("Mongolia", troops=0, owner=0)
    G.add_node("Japan", troops=0, owner=0)
    G.add_node("Afghanistan", troops=0, owner=0)
    G.add_node("China", troops=0, owner=0)
    G.add_node("Middle East", troops=0, owner=0)
    G.add_node("India", troops=0, owner=0)
    G.add_node("Siam", troops=0, owner=0)
    G.add_node("Indonesia", troops=0, owner=0)
    G.add_node("New Guinea", troops=0, owner=0)
    G.add_node("Western Australia", troops=0, owner=0)
    G.add_node("Eastern Australia", troops=0, owner=0)
